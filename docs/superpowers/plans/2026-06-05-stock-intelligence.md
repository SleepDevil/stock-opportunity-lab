...
Open `http://localhost:5173/stock`, analyze `001309`, and confirm finance plus intelligence tabs render announcement, news, and Dragon Tiger List data without console errors.
