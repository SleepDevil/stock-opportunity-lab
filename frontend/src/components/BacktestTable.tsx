...
import { StockKlineHover } from './StockKlineHover';

export function BacktestTable({ rows, loading = false, tradeDate }: { rows: BacktestRow[]; loading?: boolean; tradeDate?: string }) {
            ...
            <Table.Tr key={row.代码}>
              <Table.Td>
                <Group gap={8} wrap="nowrap">
                  ...
                  <div>
                    <StockKlineHover code={row.代码} name={row.名称} tradeDate={tradeDate}>
                      <Text component="span" fw={900} size="sm">{row.名称}</Text>
                    </StockKlineHover>
